  ...
  $(function () {
    $("body").css({
      ...
      $(".order__form").submit(function (e) {
        ...
        // https://script.google.com/macros/s/AKfycbzykayrScC4JCnjjt0-tag9kc4QuOEuPDNh52Rsw6fzJ5WQIO_ua_RFZadVrUVB_57k/exec?date={{JS-Date}}&name={{Js -name}}&tel={{Js phone}}&utm_source={{Source}}&utm_medium={{Medium}}&utm_campaign={{Compaign}}&utm_term={{Term}}&client_id={{Js Client id}}
