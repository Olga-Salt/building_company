...
!(function (t) {
  ...
  return (
    (h.prototype = {
          ...
          (o.state = r.OPENED),
            ...
            !o.options.onOpened ||
              ("function" != typeof o.options.onOpened &&
                "object" != typeof o.options.onOpened) ||
          ...
          if (
            ...
            if (
              (null === this.options.iframeURL ||
                (null !== h && void 0 !== h) ||
                (h = this.options.iframeURL),
              null === h || void 0 === h)
            )
              throw new Error("Failed to find iframe URL");
            this.$element.find("." + a + "-iframe").attr("src", h);
          }
          (this.options.bodyOverflow || d) &&
            (t("html").addClass(a + "-isOverflow"),
            d && t("body").css("overflow", "hidden")),
            ...
            (function () {
              ...
              o.options.overlay === !0 &&
                (o.options.appendToOverlay === !1
                  ? o.$overlay.appendTo("body")
                  : o.$overlay.appendTo(o.options.appendToOverlay)),
      ...
      close: function (e) {
        function i() {
          (n.state = r.CLOSED),
            ...
            (n.options.bodyOverflow || d) &&
              (t("html").removeClass(a + "-isOverflow"),
              d && t("body").css("overflow", "auto")),
            n.options.onClosed &&
            ...
            o === !1 || "" === o || void 0 === l
              ...
              : (this.$element.attr(
                ...
                n.options.navigateArrows !== !1 &&
                  this.$navigate.attr("class", a + "-navigate fadeOut"),
      ...
      setContent: function (t) {
        ...
        this.options.iframe === !1 &&
          this.$element.find("." + a + "-content").html(t);
      },
      ...
      recalcLayout: function () {
        ...
        i() &&
          ...
          (this.state != r.OPENED && this.state != r.OPENING) ||
            (this.options.iframe === !0 &&
              (s < this.options.iframeHeight + this.headerHeight + f ||
              this.isFullscreen === !0
                ? this.$element
                    .find("." + a + "-iframe")
                    .css("height", s - (this.headerHeight + f))
                : this.$element
                    .find("." + a + "-iframe")
            ...
            (function () {
              h > u && c > s
                ? (e.$element.addClass("hasScroll"),
                  e.$wrap.css("height", l - (e.headerHeight + f)))
    ...
    o.off("load." + a).on("load." + a, function (e) {
      ...
      if (0 === window.$iziModal.autoOpen && !t("." + a).is(":visible"))
        try {
          var n = t(i).data();
          "undefined" != typeof n &&
